function verifyCaptcha(e){console.log(e),jQuery("button[type=submit]").removeAttr("disabled").removeAttr("style")}function preventDefault(e){e=e||window.event,e.preventDefault&&e.preventDefault(),e.returnValue=!1}function keydown(e){for(var t=keys.length;t--;)if(e.keyCode===keys[t])return void preventDefault(e)}function wheel(e){preventDefault(e)}function disable_scroll(){window.addEventListener&&window.addEventListener("DOMMouseScroll",wheel,!1),window.onmousewheel=document.onmousewheel=wheel,document.onkeydown=keydown}function enable_scroll(){window.removeEventListener&&window.removeEventListener("DOMMouseScroll",wheel,!1),window.onmousewheel=document.onmousewheel=document.onkeydown=null}function prevSlide(e){jQuery(e).removeClass("active"),jQuery(e).prev().addClass("active").removeClass("old"),maxHeight=jQuery(".casawp-lg_slide.active").outerHeight(),jQuery("#clgFormAnchor").outerHeight(maxHeight),disable_scroll(),jQuery("html, body").stop().animate({scrollTop:jQuery("#clgFormAnchor").offset().top-jQuery("#header").outerHeight()},700,function(){enable_scroll()})}function nextSlide(e){jQuery(e).removeClass("active").addClass("old"),jQuery(e).next().addClass("active"),maxHeight=jQuery(".casawp-lg_slide.active").outerHeight(),jQuery("#clgFormAnchor").outerHeight(maxHeight),disable_scroll(),jQuery("html, body").stop().animate({scrollTop:jQuery("#clgFormAnchor").offset().top-jQuery("#header").outerHeight()},700,function(){enable_scroll()})}jQuery(function(){"use strict";!function(e){function t(){var t=new google.maps.Map(document.getElementById("casawp-lg_map"),{center:{lat:47.37796,lng:8.53992},zoom:10,mapTypeId:"roadmap",disableDefaultUI:!0}),n=document.getElementById("pac-card"),o=document.getElementById("pac-input"),a=new google.maps.places.SearchBox(o);t.controls[google.maps.ControlPosition.TOP_CENTER].push(n),t.addListener("bounds_changed",function(){a.setBounds(t.getBounds())}),google.maps.event.addDomListener(o,"keydown",function(e){13===e.keyCode&&e.preventDefault()});var r=[];a.addListener("places_changed",function(){var n=a.getPlaces();if(0!=n.length){r.forEach(function(e){e.setMap(null)}),r=[];var o=new google.maps.LatLngBounds,l="",i="",c="";n.forEach(function(n){if(!n.geometry)return void console.log("Returned place contains no geometry");if(n.address_components){var a=n.address_components.find(function(e){return e.types.indexOf("country")!==-1});a&&(l=a.short_name?a.short_name:"")}if(document.getElementById("countryName").value=l,document.getElementById("cityName").value=n.name,document.getElementById("cityLat").value=n.geometry.location.lat(),document.getElementById("cityLng").value=n.geometry.location.lng(),document.getElementById("formattedAddress").value=n.formatted_address,e("#cityLocality").length&&e("#cityPostalCode").length){if(n.address_components){var s=n.address_components.find(function(e){return e.types.indexOf("locality")!==-1});s&&(i=s.short_name?s.short_name:"");var d=n.address_components.find(function(e){return e.types.indexOf("postal_code")!==-1});d&&(c=d.short_name?d.short_name:"")}document.getElementById("cityLocality").value=i,document.getElementById("cityPostalCode").value=c}e("#pac-input").css("border-color","transparent"),r.push(new google.maps.Marker({map:t,title:n.name,position:n.geometry.location})),n.geometry.viewport?o.union(n.geometry.viewport):o.extend(n.geometry.location)}),t.fitBounds(o)}})}var n=-1;n=e(".casawp-lg_slide.active").outerHeight(),e("#clgFormAnchor").outerHeight(n),e(window).on("resize",function(){n=e(".casawp-lg_slide.active").outerHeight(),e("#clgFormAnchor").outerHeight(n)}),e(".btn-forward").on("click",function(t){t.preventDefault();var n=e(this).parent().parent().parent().parent().parent();return n.find("#pac-input").length?e("#cityName").val()?nextSlide(n):e("#pac-input").css("border-color","red"):nextSlide(n),!1}),e(".btn-backward").on("click",function(t){t.preventDefault();var n=e(this).parent().parent().parent().parent().parent();return prevSlide(n),!1}),e('input[type="range"]').rangeslider({polyfill:!1,onInit:function(){this.output=e('<div class="range-output" />').insertAfter(this.$range).html(this.$element.val())},onSlide:function(e,t){this.output.html(t)}}),"single-family-house"==e('input[name="extra_data[propertyType]"]:checked').val()&&(e("#casawp-lg-property-surface").parent().show(),e("#casawp-lg-bathroom").parent().hide()),e('input[type="radio"][name="extra_data[propertyType]"]').change(function(){"single-family-house"==e('input[name="extra_data[propertyType]"]:checked').val()?(e("#casawp-lg-property-surface").parent().show(),e("#casawp-lg-bathroom").parent().hide()):"flat"==e('input[name="extra_data[propertyType]"]:checked').val()&&(e("#casawp-lg-property-surface").parent().hide(),e("#casawp-lg-bathroom").parent().show())}),e("#casawp-lg_map").length&&t()}(jQuery)});
