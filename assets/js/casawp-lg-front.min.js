function verifyCaptcha(e){console.log(e),jQuery("button[type=submit]").removeAttr("disabled").removeAttr("style")}function prevSlide(e){$(e).removeClass("active"),$(e).prev().addClass("active").removeClass("old"),maxHeight=$(".casawp-lg_slide.active").outerHeight(),$("#clgFormAnchor").outerHeight(maxHeight)}function nextSlide(e){$(e).removeClass("active").addClass("old"),$(e).next().addClass("active"),maxHeight=$(".casawp-lg_slide.active").outerHeight(),$("#clgFormAnchor").outerHeight(maxHeight)}jQuery(function(){"use strict";!function(e){function t(){var t=new google.maps.Map(document.getElementById("casawp-lg_map"),{center:{lat:47.37796,lng:8.53992},zoom:10,mapTypeId:"roadmap",disableDefaultUI:!0}),a=document.getElementById("pac-card"),n=document.getElementById("pac-input"),o=new google.maps.places.SearchBox(n);t.controls[google.maps.ControlPosition.TOP_CENTER].push(a),t.addListener("bounds_changed",function(){o.setBounds(t.getBounds())}),google.maps.event.addDomListener(n,"keydown",function(e){13===e.keyCode&&e.preventDefault()});var r=[];o.addListener("places_changed",function(){var a=o.getPlaces();if(0!=a.length){r.forEach(function(e){e.setMap(null)}),r=[];var n=new google.maps.LatLngBounds,i="";a.forEach(function(a){if(!a.geometry)return void console.log("Returned place contains no geometry");if(a.address_components){var o=a.address_components.find(function(e){return e.types.indexOf("country")!==-1});o&&(i=o.short_name?o.short_name:"")}document.getElementById("countryName").value=i,document.getElementById("cityName").value=a.name,document.getElementById("cityLat").value=a.geometry.location.lat(),document.getElementById("cityLng").value=a.geometry.location.lng(),e("#pac-input").css("border-color","transparent"),r.push(new google.maps.Marker({map:t,title:a.name,position:a.geometry.location})),a.geometry.viewport?n.union(a.geometry.viewport):n.extend(a.geometry.location)}),t.fitBounds(n)}})}var a=-1;a=e(".casawp-lg_slide.active").outerHeight(),e("#clgFormAnchor").outerHeight(a),e(window).resize(function(){a=e(".casawp-lg_slide.active").outerHeight(),e("#clgFormAnchor").outerHeight(a)}),e(".btn-forward").click(function(t){t.preventDefault();var a=e(this).parent().parent().parent().parent().parent();return a.find("#pac-input").length?e("#cityName").val()?nextSlide(a):e("#pac-input").css("border-color","red"):nextSlide(a),!1}),e(".btn-backward").click(function(t){t.preventDefault();var a=e(this).parent().parent().parent().parent().parent();return prevSlide(a),!1}),e('input[type="range"]').rangeslider({polyfill:!1,onInit:function(){this.output=e('<div class="range-output" />').insertAfter(this.$range).html(this.$element.val())},onSlide:function(e,t){this.output.html(t)}}),"single-family-house"==e('input[name="extra_data[propertyType]"]:checked').val()&&(e("#casawp-lg-property-surface").parent().show(),e("#casawp-lg-bathroom").parent().hide()),e('input[type="radio"][name="extra_data[propertyType]"]').change(function(){"single-family-house"==e('input[name="extra_data[propertyType]"]:checked').val()?(e("#casawp-lg-property-surface").parent().show(),e("#casawp-lg-bathroom").parent().hide()):(e("#casawp-lg-property-surface").parent().hide(),e("#casawp-lg-bathroom").parent().show())}),e("#casawp-lg_map").length&&t()}(jQuery)});
