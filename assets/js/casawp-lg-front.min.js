jQuery(function(){"use strict";!function(e){function t(t){e(t).removeClass("active"),e(t).prev().addClass("active").removeClass("old")}function a(t){e(t).removeClass("active").addClass("old"),e(t).next().addClass("active")}function n(){var t=new google.maps.Map(document.getElementById("casawp-lg_map"),{center:{lat:47.37796,lng:8.53992},zoom:10,mapTypeId:"roadmap",disableDefaultUI:!0}),a=document.getElementById("pac-card"),n=document.getElementById("pac-input"),o=new google.maps.places.SearchBox(n);t.controls[google.maps.ControlPosition.TOP_CENTER].push(a),t.addListener("bounds_changed",function(){o.setBounds(t.getBounds())});var r=[];o.addListener("places_changed",function(){var a=o.getPlaces();if(0!=a.length){r.forEach(function(e){e.setMap(null)}),r=[];var n=new google.maps.LatLngBounds,i="";a.forEach(function(a){if(!a.geometry)return void console.log("Returned place contains no geometry");if(a.address_components){var o=a.address_components.find(function(e){return e.types.indexOf("country")!==-1});o&&(i=o.short_name?o.short_name:"")}document.getElementById("countryName").value=i,document.getElementById("cityName").value=a.name,document.getElementById("cityLat").value=a.geometry.location.lat(),document.getElementById("cityLng").value=a.geometry.location.lng(),e("#pac-input").css("border-color","transparent"),r.push(new google.maps.Marker({map:t,title:a.name,position:a.geometry.location})),a.geometry.viewport?n.union(a.geometry.viewport):n.extend(a.geometry.location)}),t.fitBounds(n)}})}var o=-1;e(".casawp-lg_slide").each(function(){o=o>e(this).height()?o:e(this).height()}),e("#clgFormAnchor").outerHeight(o),e(window).resize(function(){e(".casawp-lg_slide").each(function(){o=o>e(this).height()?o:e(this).height()}),e(".casawp-lg-wrapper_inner").outerHeight(o)}),e(".btn-forward").click(function(t){t.preventDefault();var n=e(this).parent().parent().parent().parent().parent();return n.find("#pac-input").length?e("#cityName").val()?a(n):e("#pac-input").css("border-color","red"):a(n),!1}),e(".btn-backward").click(function(a){a.preventDefault();var n=e(this).parent().parent().parent().parent().parent();return t(n),!1}),e('input[type="range"]').rangeslider({polyfill:!1,onInit:function(){this.output=e('<div class="range-output" />').insertAfter(this.$range).html(this.$element.val())},onSlide:function(e,t){this.output.html(t)}}),"Einfamilienhaus"==e('input[name="extra_data[Objektart]"]:checked').val()&&(e("#casawp-lg-property-surface").parent().show(),e("#casawp-lg-bathroom").parent().hide()),e('input[type="radio"][name="extra_data[Objektart]"]').change(function(){"Einfamilienhaus"==e('input[name="extra_data[Objektart]"]:checked').val()?(e("#casawp-lg-property-surface").parent().show(),e("#casawp-lg-bathroom").parent().hide()):(e("#casawp-lg-property-surface").parent().hide(),e("#casawp-lg-bathroom").parent().show())}),e("#casawp-lg_map").length&&n()}(jQuery)});
