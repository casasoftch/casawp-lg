                            ...
                            <div class="casawp-lg_slideinner">
                                ...
                                <?php 
                                    $html = '<div class="casawp-lg_mapwrapper">
                                                ...
                                                <input required type="hidden" id="countryName" name="extra_data[country]">
                                ...
                                <?php 
                                    $html = '<div class="casawp-lg_datawrapper">
                                                ...
                                                <div class="casawp-lg_range">
                                                    ...
                                                    <input type="range" min="1" max="1500" step="1" value="400" id="casawp-lg-property-surface" name="extra_data[areaPropertyLand]" data-rangeslider>
                                                ...
                                                <div class="casawp-lg_range">
                                                    ...
                                                    <input type="range" min="1" max="10" step="0.5" name="extra_data[numberOfRooms]" value="3" data-rangeslider>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="casawp-lg_range">
                                                    <label class="control-label">'.__('Number of bathrooms', 'casawplg').'</label>
                                                    <input type="range" min="1" max="10" step="1" id="casawp-lg-bathroom" name="extra_data[numberOfBathrooms]" value="1" data-rangeslider>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="casawp-lg_range">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="g-recaptcha" data-callback="iaziVerifyCaptcha" data-sitekey="6LdEPXEUAAAAAFmTE5tfxTTT42SZuarZcK1kLHvp"></div>
