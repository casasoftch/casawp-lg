...
class building_metabox extends Feature {
	...
	public $prefix = 'casawplg_building_';
	...
	public function add_group_column( $columns ){
	    $columns['hide_building'] = __( 'Visible', 'casawplg' );
	    $columns['has_building_col_options'] = __( 'Options', 'casawplg' );
	    return $columns;
	}
	...
	public function add_group_field($term, $taxonomy) {
		$default_cols = clg_get_list_col_defaults();
		?>
...
add_action( 'casawplg_init', array( 'casasoft\casawplg\building_metabox', 'init' ), 90  );
