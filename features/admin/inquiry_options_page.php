	...
	public function __construct() {
		if( function_exists('acf_add_local_field_group') ):
			acf_add_options_sub_page(array(
				...
				'parent' => 'edit.php?post_type=casawplg_inquiry'
			));
        ...
        $row['ID'] = $inq->ID;
				...
				foreach ($fields as $field) {
					...
					$row[get_clg_label(false, $field, 'casawplg_inquiry')] = str_replace("\r", "", str_replace("\n", '' , nl2br($value)));
				}
...
add_action( 'casawplg_init', array( 'casasoft\casawplg\inquiry_options_page', 'init' ));
