...
class render extends Feature {
    ...
    function registerScriptsAndStyles() {
        ...
        wp_register_script( 'casawp-lg-front', PLUGIN_URL . 'assets/js/casawp-lg-front.min.js', array('jquery'), '10');
    ...
    private function prepareData($formData) {
        ...
        */
        ...
        $fullData = [
            "name" => !empty($formData['first_name']) ? $formData['first_name'] : null,
            "surname" => !empty($formData['last_name']) ? $formData['last_name'] : null,
            "culture" => 'de-CH',
            "email" => !empty($formData['email']) ? $formData['email'] : null,
            "mobile" => !empty($formData['mobile']) ? $formData['mobile'] : null,
            "message" => !empty($formData['message']) ? $formData['message'] : null,
            "gender" => !empty($formData['gender']) ? $formData['gender'] : null,
            "categoryCode" => !empty($formData['extra_data']['propertyType']) ? $formData['extra_data']['propertyType'] : null,
            "countryCode" => !empty($formData['extra_data']['country']) ? $formData['extra_data']['country'] : null,
            "latitude" => !empty($formData['extra_data']['lat']) ? $formData['extra_data']['lat'] : 0,
            "longitude" => !empty($formData['extra_data']['lng']) ? $formData['extra_data']['lng'] : 0,
            "formattedAddress" => !empty($formData['extra_data']['formattedAddress']) ? $formData['extra_data']['formattedAddress'] : 0,
            "surfaceLiving" => !empty($formData['extra_data']['areaNwf']) ? $formData['extra_data']['areaNwf'] : 0,
            "surfaceGround" => !empty($formData['extra_data']['areaPropertyLand']) ? $formData['extra_data']['areaPropertyLand'] : 0,
            "roomNb" => !empty($formData['extra_data']['numberOfRooms']) ? $formData['extra_data']['numberOfRooms'] : 0,
            "bathNb" => !empty($formData['extra_data']['numberOfBathrooms']) ? $formData['extra_data']['numberOfBathrooms'] : 0,
            "buildYear" => !empty($formData['extra_data']['yearBuilt']) ? $formData['extra_data']['yearBuilt'] : 0,
            "sale" => !empty($formData['extra_data']['sell']),
            "purchase" => !empty($formData['extra_data']['buy']),
            "financing" => !empty($formData['extra_data']['financing']),
            "other" => !empty($formData['extra_data']['other']),
        ];
